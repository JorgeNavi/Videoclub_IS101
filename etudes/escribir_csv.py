...
with open("data\grupos_zoo.csv", "a", newline="") as fichero: #como nombre de fichero
    escribidor_csv_dicc = csv.DictWriter(fichero, fieldnames=["id_grupo", "tipo_entrada", "cantidad_entrada", "subtotal"], delimiter=";", quotechar="'")
    escribidor_csv_dicc.writerows([
